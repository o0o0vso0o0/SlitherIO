(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/SnakeControl/LocalControl.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '71788YhtEFOP4XPq/No+SYd', 'LocalControl', __filename);
// Script/SnakeControl/LocalControl.js
...
cc.Class({
    ...
    updateBodySpacing: function updateBodySpacing() {
    ...
    removeTargetVector: function removeTargetVector() {
    ...
    pullFood: function pullFood(score) {
    ...
    updateSnakeBody: function updateSnakeBody() {
        ...
        for (var i = 0, j = 1; j < this.snake.body.length; ++i, ++j) {
            ...
            if (j == this.snake.body.length - 1) moveDistance += this.bodySpacing * (Math.ceil(this.snake.bodyLength) - this.snake.bodyLength);
    ...
    pulsatingFeedback: function pulsatingFeedback() {
    ...
    onCollisionEnter: function onCollisionEnter(other, self) {
        if (other.node == null || other.node.active == false || this.node == null || this.node.active == false) {
            //貌似能解决两蛇对撞导致卡死的bug
            return;
        }
        if (self != this) {
        ...
        if (other.node.groupIndex == o0Game.GroupIndex.Body) {
            ...
            var selfBody = false;
            if (this.snake.body.length > 1) for (var i = 1; i < this.snake.body.length; ++i) {
