(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Snake/Snake.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c1ad1IhihRLBrWWB03nqOLd', 'Snake', __filename);
// Script/Snake/Snake.js
...
cc.Class({
    ...
    addEyeGraphic: function addEyeGraphic(node) {
    ...
    addGraphic: function addGraphic(node) {
    ...
    addGraphic2: function addGraphic2(node) {
        var graphics = node.addComponent(cc.Graphics);
        graphics.clear();
        graphics.circle(0, 0, this.radius);
        graphics.fillColor = cc.Color.YELLOW;
    ...
    removeAllBody: function removeAllBody() {
