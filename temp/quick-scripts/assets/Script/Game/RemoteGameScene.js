(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Game/RemoteGameScene.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '41f21LY+0xMd7OarH5pQYgS', 'RemoteGameScene', __filename);
// Script/Game/RemoteGameScene.js
...
cc.Class({
    ...
    processData: function processData(event) {
        ...
        if (this.isHost) {
            //cc.log(event.data);
            if (serverData['fromId'] != null && data != null && data['name'] != null && data['skin'] != null) {
            ...
            if (serverData['fromId'] != null && data != null && data['vector'] != null && data['vector']['x'] != null && data['vector']['y'] != null && data['speeding'] != null && this.connectionIdToSnakeId[serverData['fromId']] != null) {
            ...
            if (data != null) {
                ...
                if (data['snake'] != null) {
                    ...
                    for (var i = 0; i < this.snakeNode.childrenCount; ++i) {
                        ...
                        if (snake.isValid == true) snakes[snake.name] = snake;
                        //cc.log('0: '+snake.name);
                    }

                    for (var i = 0; i < data['snake'].length; ++i) {
                        var snakeData = data['snake'][i];
                        if (snakeData != null && snakeData['id'] != null && snakeData['score'] != null && snakeData['position'] != null && snakeData['rotation'] != null && snakeData['skin'] != null) {
                ...
                if (data['food'] != null) {
                    ...
                    for (var i = 0; i < this.foodNode.childrenCount; ++i) {
                        ...
                        if (food.isValid == true) foods[food.name] = food;
                        //cc.log('0: '+snake.name);
                    }

                    for (var i = 0; i < data['food'].length; ++i) {
                        var foodData = data['food'][i];
                        if (foodData != null && foodData['id'] != null && foodData['score'] != null && foodData['position'] != null) {
                            //cc.log('1: '+snakeData['id']);
    ...
    generatePlayerSnake: function generatePlayerSnake(data) {
        if (this.isHost == true) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=RemoteGameScene.js.map
